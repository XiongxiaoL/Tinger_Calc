...
public class B_F2 extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.b_f2,null);
        initView(view);
        setOnClickListener();
    ...
    private void count() {
        ...
        if(numData == 2) {
            ...
            switch (res) {
                case "x":
                    x = decimalFormat.format(dw / dr);
                    break;
                case "w":
                    w = decimalFormat.format(dx * dr);
                    break;
                case "r":
                    r = decimalFormat.format(dw / dx);
                    break;
