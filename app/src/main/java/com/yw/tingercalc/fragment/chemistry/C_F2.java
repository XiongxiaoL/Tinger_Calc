...
public class C_F2 extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.c_f2,null);
        initView(view);
        setOnClickListener();
        ...
        if(numData == 3) {
            ...
            switch (res) {
                case "z":
                    ...
                    z = decimalFormat.format(dn * dt * df);
                    break;

                case "n":
                    n = decimalFormat.format(dz / (df * dt));
                    break;

                case "t":
                    t = decimalFormat.format(dz / (df * dn));
                    break;
